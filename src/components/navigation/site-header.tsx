...
import { APP_ROLES } from "@/lib/auth/require-role";
...
export async function SiteHeader() {
  ...
  const roleResults = signedIn ? await Promise.all(APP_ROLES.map((role) => client.rpc("current_user_has_role", { p_role: role }))) : [];
